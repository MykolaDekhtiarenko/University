...
<div id="popup" class="popupinput">
    <div class="popup-content">
        <h3>Змініть дані</h3>
        <form:form method="POST" modelAttribute="XML" action="${pageContext.request.contextPath}/editXML/${id}">
            <label for="xml">Файл: </label>
            <form:input class="form-control" type="text" value="${xml}" path="xml" /><br>
            <br>
