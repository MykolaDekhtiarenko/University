...
<div id="popup" class="popupinput">
    <div class="popup-content">
        <h3>Введіть дані</h3>
        <form:form method="POST" modelAttribute="DisciplineForm" action="${pageContext.request.contextPath}/discipline/add">
        <div class="form-group">
            ...
            <form:input class="form-control" path="credits"/><br>
            <form:checkbox class="recommended" value="recommended" path="recommended"/>Рекомендована
            <br>
            <div id="close" class="btn btn-default">Відмінити</div>
            <form:button id="add" type="submit" class="btn btn-primary">Додати</form:button>
        </div>
        </form:form>
    </div>
</div>
