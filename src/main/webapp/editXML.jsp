...
<div id="popup" class="popupinput">
    <div class="popup-content">
        <h3>Змініть дані</h3>
        <form:form method="POST" modelAttribute="DisciplineForm" action="${pageContext.request.contextPath}/edit/${discipline.id}">
            <div class="form-group">
            <label for="teacher">Викладач:</label>
            <form:input id="teacher" class="form-control" value="${discipline.teacher}" type="text" path="teacher"/>
            <br>
            <label for="description">Аннотація: </label>
            <form:input class="form-control" value="${discipline.description}" path="description"/><br>
